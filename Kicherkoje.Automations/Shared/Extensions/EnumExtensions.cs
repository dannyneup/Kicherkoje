...
public static class EnumExtensions
{
    public static string GetHaStringRepresentation(this Enum value)
    {
        ...
        throw new InvalidOperationException(
            $"Enum value '{value}' of type {enumType} does not have a {typeof(HaStringRepresentationAttribute)} attribute.");
    }
    ...
    public static string GetHaStringRepresentation(this Type enumType)
    {
        ...
        throw new InvalidOperationException(
            $"Enum type '{enumType}' does not have a {typeof(HaStringRepresentationAttribute)} attribute.");
    }
    ...
    private static string? GetHaStringRepresentationAttributeValue(MemberInfo field) =>
        field.IsDefined(typeof(HaStringRepresentationAttribute))
            ? ((HaStringRepresentationAttribute)field.GetCustomAttribute(typeof(HaStringRepresentationAttribute))!)
            .State
            : null;
}